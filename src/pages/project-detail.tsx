    ...
    <Shell>
      <main className="pt-[76px]">
        ...
        <section className="container-shell grid gap-5 pb-12 md:grid-cols-[1.35fr_.65fr]">
          ...
          <FadeIn delay={0.2} className="flex flex-col justify-between rounded-2xl bg-[#56293a] p-7 text-[#fff8ea] md:p-9">
            <div>
        ...
        <section className="bg-[#f1e6d6] py-16 md:py-24">
          <div className="container-shell grid gap-10 md:grid-cols-[.9fr_1.1fr]">
            ...
            <FadeIn delay={0.2} className="rounded-2xl bg-[#56293a] p-7 text-[#fff8ea] md:p-10">
        ...
        <section className="container-shell py-16 md:py-24">
          <div className="grid gap-10 md:grid-cols-[1fr_1fr]">
            ...
            <FadeIn delay={0.2} className="rounded-2xl border border-[#e5d4b9] p-6 md:p-8">
              <p className="eyebrow">Have questions?</p><h3 className="mt-4 font-display text-3xl text-[#56293a]">Ask us on WhatsApp.</h3><p className="mt-3 text-sm leading-6 text-[#735e57]">Scan to start a conversation about {project.name}.</p>
